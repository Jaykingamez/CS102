...
public class Round {
    ...
    public void startTurn() {
        ...
        if (!(currentPlayer instanceof BotPlayer)) {
            System.out.println(currentPlayer.getPRole().getRoleDescription() + ": "
                    + currentPlayer.getPRole().getRoleDescription());
        }
                ...
                if (currentPlayer instanceof BotPlayer) {
                    ...
                    while (!validRaise) {
                        ...
                        if (raise > 0 && raise <= currentPlayer.getAmount() - currentBet) {
                            ...
                            System.out.println(
                                    "Invalid Raise! (Raise must be in valid range; Remember that raise amount excludes call amount)");
                            System.out.println();
                            scan.nextLine();
                            raise = 0;
                        }
